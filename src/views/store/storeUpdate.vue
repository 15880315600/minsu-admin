        ...
        <el-col :span="14">
          <div>
            <el-form-item label="门店地址" prop="address">
              <xmap v-if="isStatus" :longitude="temp.longitude" :latitude="temp.latitude"
                :receive-store-detail-address="temp.address" :is-edit="isEdit" @location="location" />
...
<script>
  ...
  import xmap from '../../components/Amap/xmap.vue'
  ...
  export default {
    ...
    methods: {
      ...
      location(data) {
        console.log(data)
        this.temp.longitude = data.lng
        this.temp.latitude = data.lat
        this.temp.areaCode = data.citycode
        this.temp.address = data.address
        this.temp.province = data.province
        this.temp.city = data.city
        this.temp.region = data.region
      }
