<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="房间类型" align="center" width="100">
        <template slot-scope="scope">
      ...
      <el-table-column label="是否特价房" align="center" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column label="产品现价" align="center" width="90">
        <template slot-scope="scope">
          <span>{{ scope.row.roomPriceNow }}</span>
        </template>
      </el-table-column>

      <el-table-column label="是否有窗" align="center" width="100">
        <template slot-scope="scope">
	  ...
	  <el-table-column label="面积数" align="center" width="90">
	    <template slot-scope="scope">
	      <span>{{ scope.row.roomArea }}</span>
	    </template>
	  </el-table-column>

      <el-table-column label="房间状态" align="center" width="80">
        <template slot-scope="scope">
